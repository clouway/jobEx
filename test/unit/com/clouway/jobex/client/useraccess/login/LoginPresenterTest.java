...
//
//    when(authorizationService.login(loginType, email, password)).thenReturn(false);
//
...
//
//    when(authorizationService.login("User", email, password)).thenReturn(true);
//
//    presenter.login("User", email, password);
//
...
//
//    when(authorizationService.login("Company", email, password)).thenReturn(true);
//
//    presenter.login("Company", email, password);
//
