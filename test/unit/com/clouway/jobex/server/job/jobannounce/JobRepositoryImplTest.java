...
public class JobRepositoryImplTest {
  ...
  @Test
  public void prepareJobWithAutoGeneratedId() {

    Job job = repository.prepareNewJob();

    assertThat(job, is(notNullValue()));
    assertThat(job.getId(), is(notNullValue()));
  }

  @Test
  public void prepareTwoJobsWithDifferentIDs() {

    Job firstJob = repository.prepareNewJob();
    Job secondJob = repository.prepareNewJob();

    assertThat(firstJob.getId(), IsNot.not(equalTo(secondJob.getId())));
  }
}
